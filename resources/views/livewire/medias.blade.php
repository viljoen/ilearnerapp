<div class="p-6">
    ...
    <div x-data="{tab: window.location.hash ? window.location.hash : '#courseInfo'}" class="">
        ...
        <div x-show="tab == '#audio'" x-cloak>
            ...
            <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
                <form action="...">
                    <label for="img">Upload audio:</label>
        ...
        <div x-show="tab == '#docs'" x-cloak>
            ...
            <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
                <form action="...">
                    <label for="img">Upload document:</label>
                    <input type="file" id="doc" name="doc" accept=".doc, .docx, .pdf, .xlsx, .xls,.PPT">
                    <input type="submit">
                </form>
            </div>
        </div>
        ...
        <div x-show="tab == '#zip'" x-cloak>
            ...
            <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6">
                <form action="...">
                    <label for="img">Upload Zip file:</label>
                    <input type="file" id="doc" name="doc" accept=".zip">
                    <input type="submit">
                </form>
            </div>
        </div>
