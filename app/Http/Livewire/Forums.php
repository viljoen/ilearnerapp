        ...
        */
         ...
         */
          ...
          */
           ...
           *                    return Forum::paginate(5);
           *                }
           */
              public function read(){
                  return Forum::search($this->search)
            ...
            */
               public function update(){
                   $this->validate();
                   Forum::find($this->modelId)->update($this->modelData());
                   $this->modalFormVisible = false;
               }
